# https://www.josean.com/posts/sketchybar-setup -- "Install and setup sketchybar-app-font"
...
function icon_map() {
  ...
  "MAMP" | "MAMP PRO")
    icon_result=":mamp:"
    ;;
  "Superhuman" | "Canary Mail" | "HEY" | "Mail" | "Mailspring" | "MailMate" | "邮件")
    icon_result=":mail:"
    ;;
  "WebStorm")
  ...
  "Music" | "音乐")
    icon_result=":music:"
    ;;
  "Notion Calendar" | "Calendar" | "日历" | "Fantastical" | "Cron" | "Amie")
