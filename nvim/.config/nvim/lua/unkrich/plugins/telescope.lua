return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>sf", "<cmd>Telescope git_files<cr>", { desc = "Fuzzy find files in cwd" })
    keymap.set("n", "<leader><space>", "<cmd>Telescope buffers<cr>", { desc = "Fuzzy find recent files" })
